                    ...
                    <tbody class="divide-y divide-gray-200">
                        <template x-for="(item, index) in $.list">
                            <tr class="odd:bg-teal-50 even:bg-blue-50">
                                <td x-text="item.last_name + ' ' +item.first_name" x-on:click="$.userRep(item.id)" class="p-1 text-sm font-medium text-gray-900 cursor-pointer border-x whitespace-nowrap"></td>
                                <template x-for="day in $.no_of_days">
